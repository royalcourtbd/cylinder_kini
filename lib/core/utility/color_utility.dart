...
//       hexColorWithAlpha.contains("0x") ? hexColorWithAlpha : "0x$hexColorWithAlpha",
//     );
...
// ColorFilter buildColorFilter(Color? color) => ColorFilter.mode(color ?? Colors.black, BlendMode.srcATop);
